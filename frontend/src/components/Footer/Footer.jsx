        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "40px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
            <div>
              ...
              <p style={{ fontSize: "14px", color: "#d1d5db" }}><span style={{ color: "#34d399", fontWeight: "500" }}>Shivanand Pal</span> — CSE undergrad focused on real-time apps & design.</p>
              <p style={{ fontSize: "14px", color: "#d1d5db" }}><span style={{ color: "#34d399", fontWeight: "500" }}>[Your Teammate]</span> — Backend developer optimizing APIs and systems.</p>
            </div>
            <div>
